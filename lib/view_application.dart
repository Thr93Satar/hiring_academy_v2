          ...
          Expanded(
            child: Stack(
              children: [
                      ...
                      Row(
                        ...
                        children: [
                              ...
                              child: Row(
                                children: const [
                                  Padding(
                                    ...
                                    child: Icon(Icons.question_answer, size: 20, color: Colors.black,),
                                  ),
                                  SizedBox(
                                    width: 5,
                                  ),
                                  Text('Ask Question',style: TextStyle(fontWeight:FontWeight.bold,color: Colors.deepPurple),),
                                ],
                              ),
                          ...
                          Padding(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => const SubmittedApp()));
                              },
                              child: Row(
                                children: const [
                                  Text('Apply', style: TextStyle(fontWeight:FontWeight.bold, color: Colors.deepPurple),),
                                  SizedBox(
                                    width: 5,
                                  ),
                                  Padding(
                                    padding: EdgeInsets.only(top: 5.0),
                                    child: Icon(Icons.add_circle, size: 20, color: Colors.black,),
                                  ),
                                ],
                              ),
                              style: ElevatedButton.styleFrom(
                ...
                Padding(
                  padding: const EdgeInsets.only(top: 50.0,bottom: 70.0, left: 10.0,right: 10.0),
                  child: Container(
                   decoration: BoxDecoration(
                     color: elementcolor,
                   ),
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            const Padding(
                              padding: EdgeInsets.only(top: 5.0),
                              child: const Icon(Icons.upload, size: 25, color: Colors.black,),
                            ),
                          ],
                        ),
                        Padding(
