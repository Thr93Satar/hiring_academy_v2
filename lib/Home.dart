      ...
      body: Column(
        ...
        children: [
          ...
          Expanded(
            ...
            child: Row(
              children: [
                const SizedBox(   //---------------------- padding right --------------------//
                  width: 10,
                ),
                Expanded(
                  child: ListView(   //------------------------- Listview Start --------------------//
                      shrinkWrap: true,
                      scrollDirection: Axis.horizontal,
                      children: [
                        Column( //----------------------------------Vertical box--------------------------//
                                      ...
                                      InkWell(
                                        ...
                                        child: Stack(
                                            ...
                                            children: [
                                              ...
                                              const Padding(
                                                padding: EdgeInsets.only(right: 160, bottom: 5.0),
                                                child: Text(
                                                  'Music celebration', textAlign: TextAlign.start,
                                                  style: TextStyle(
                                                      color: Colors.white),
                                                ),
                                              ),
