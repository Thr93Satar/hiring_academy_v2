...
class JobCreatedSuccessfully extends StatefulWidget {
  const JobCreatedSuccessfully({Key? key}) : super(key: key);

  @override
  State<JobCreatedSuccessfully> createState() => _JobCreatedSuccessfullyState();
}

class _JobCreatedSuccessfullyState extends State<JobCreatedSuccessfully> {
  @override
