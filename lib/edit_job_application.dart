...
class EditJobApplication extends StatefulWidget {
  const EditJobApplication({Key? key}) : super(key: key);

  @override
  State<EditJobApplication> createState() => _EditJobApplicationState();
}

class _EditJobApplicationState extends State<EditJobApplication> {
  @override
